...
| `/execute-plan`          | Runs ~3 tasks per batch with subagents. Post-execution quality sequence. Checks open questions in spec.                                                          | Spec moved to `docs/5. built/<category>/<feature>/`            |
