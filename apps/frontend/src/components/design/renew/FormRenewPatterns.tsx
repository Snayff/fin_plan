...
function DemoInput({
  ...
  const borderClass = {
    ...
    warning: 'border-staleness ring-2 ring-staleness/20',
    disabled: 'border-border opacity-50',
    success: 'border-income ring-2 ring-income/20',
  }[state];
  ...
  return (
    <div className="space-y-12">
      ...
      <PatternSection
        id="input-states"
        title="Input states"
        description="All form inputs provide six states. Error uses destructive (red), warning uses staleness (amber), success uses income (teal) — consistent with the colour signal rules."
        useWhen={[
        ...
        avoidWhen={[
          'Using error state for staleness or informational warnings — those use amber (staleness)',
      ...
      >
        <div className="grid grid-cols-2 gap-6 max-w-xl">
          ...
          <DemoInput label="Focused" value="£5,148" state="focused" message="Keyboard focus or click" />
          <DemoInput
            label="Error"
            value="not a number"
            state="error"
          ...
          />
          <DemoInput label="Disabled" value="£5,148" state="disabled" message="Read-only or locked" />
        ...
        <div className="space-y-4 max-w-sm">
          <PatternExample label="Mandatory fields visible, optional hidden">
            <div className="space-y-3">
              ...
              <button className="text-sm text-primary hover:underline text-left">+ More options</button>
            </div>
          </PatternExample>
        ...
        <div className="grid grid-cols-2 gap-4">
          <PatternExample label="Before — detail view">
            <div className="space-y-2 text-sm">
              ...
              <p className="text-3xl font-semibold font-mono text-income tabular-nums">£122</p>
              ...
              <div className="flex gap-2 pt-1">
                <button className="px-3 py-1.5 text-xs rounded border border-border text-foreground">Edit</button>
          ...
          <PatternExample label="After clicking Edit — form in same position, same breadcrumb">
            <div className="space-y-3 text-sm">
              ...
              <div className="flex gap-2 pt-1">
                <button className="px-3 py-1.5 text-xs rounded border border-border text-foreground">Cancel</button>
